package com.example.danny.drawapp;
...
public class MainActivity extends ActionBarActivity implements OnClickListener {
    ...
    private ImageButton currPaint, drawBtn, eraseBtn, newBtn, saveBtn,squareBtn,circleBtn, lineBtn, polygonBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        squareBtn = (ImageButton)findViewById(R.id.square_btn);
...
//respond to clicks
        if(view.getId()==R.id.draw_btn){
            ...
            drawView.mode = "square";

            AlertDialog.Builder builder = new AlertDialog.Builder(this);
            builder.setTitle("Select a Pixel Size");
            ...
            builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    drawView.scale = Integer.parseInt(input.getText().toString());
                 }
                 });
